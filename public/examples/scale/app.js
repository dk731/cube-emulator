...
const anim_objects = {
  sphere1: {
    points: [
      2455, 2456, 2438, 2439, 2440, 2441, 2422, 2423, 2424, 2425, 2407, 2408,
      2198, 2199, 2200, 2201, 2182, 2183, 2184, 2185, 2166, 2167, 2168, 2169,
      2150, 2151, 2152, 2153, 1942, 1943, 1944, 1945, 1926, 1927, 1928, 1929,
      1910, 1911, 1912, 1913, 1894, 1895, 1896, 1897, 1687, 1688, 1670, 1671,
      1672, 1673, 1654, 1655, 1656, 1657, 1639, 1640,
    ],
    point_s: {
      r: start_color,
      g: start_color,
    ...
    point_e: { r: 1, g: 1, b: 1, x: 3, y: 3, z: 3 },
    origin_s: JSON.parse(JSON.stringify(origin_pos)),
    origin_e: JSON.parse(JSON.stringify(new THREE.Vector3().copy(offset_1))),
    origin_trans_scale: { x: 7.5, y: 7.5, z: 7.5 },
  },
};

//////////////////////////////////////////////////////

function anim_pixels(pix_list, start_col_s, end_col_s, anim_time, delay) {
...
function anim_translate(start_pos, end_pos, anim_time, delay) {
...
function anim_scale(start_scale, end_scale, anim_time, delay) {
...
function animation_flow() {
  anim_translate(origin_pos, offset_1, 2000, 1000);
  ...
  anim_pixels(
    [
      2966, 2967, 2968, 2969, 2949, 2950, 2951, 2952, 2953, 2954, 2933, 2934,
      2935, 2936, 2937, 2938, 2918, 2919, 2920, 2921, 2725, 2726, 2727, 2728,
      2729, 2730, 2708, 2709, 2710, 2713, 2714, 2715, 2691, 2692, 2693, 2698,
      2699, 2700, 2675, 2676, 2677, 2682, 2683, 2684, 2660, 2661, 2662, 2665,
      2666, 2667, 2645, 2646, 2647, 2648, 2649, 2650, 2486, 2487, 2488, 2489,
      2468, 2469, 2470, 2473, 2474, 2475, 2451, 2452, 2459, 2460, 2434, 2435,
      2444, 2445, 2418, 2419, 2428, 2429, 2403, 2404, 2411, 2412, 2388, 2389,
      2390, 2393, 2394, 2395, 2374, 2375, 2376, 2377, 2229, 2230, 2231, 2232,
      2233, 2234, 2211, 2212, 2213, 2218, 2219, 2220, 2194, 2195, 2204, 2205,
      2178, 2179, 2188, 2189, 2162, 2163, 2172, 2173, 2146, 2147, 2156, 2157,
      2131, 2132, 2133, 2138, 2139, 2140, 2117, 2118, 2119, 2120, 2121, 2122,
      1973, 1974, 1975, 1976, 1977, 1978, 1955, 1956, 1957, 1962, 1963, 1964,
      1938, 1939, 1948, 1949, 1922, 1923, 1932, 1933, 1906, 1907, 1916, 1917,
      1890, 1891, 1900, 1901, 1875, 1876, 1877, 1882, 1883, 1884, 1861, 1862,
      1863, 1864, 1865, 1866, 1718, 1719, 1720, 1721, 1700, 1701, 1702, 1705,
      1706, 1707, 1683, 1684, 1691, 1692, 1666, 1667, 1676, 1677, 1650, 1651,
      1660, 1661, 1635, 1636, 1643, 1644, 1620, 1621, 1622, 1625, 1626, 1627,
      1606, 1607, 1608, 1609, 1445, 1446, 1447, 1448, 1449, 1450, 1428, 1429,
      1430, 1433, 1434, 1435, 1411, 1412, 1413, 1418, 1419, 1420, 1395, 1396,
      1397, 1402, 1403, 1404, 1380, 1381, 1382, 1385, 1386, 1387, 1365, 1366,
      1367, 1368, 1369, 1370, 1174, 1175, 1176, 1177, 1157, 1158, 1159, 1160,
      1161, 1162, 1141, 1142, 1143, 1144, 1145, 1146, 1126, 1127, 1128, 1129,
    ],
    defualt_pix,
  ...
  anim_translate(origin_pos, offset_2, 2000, 16000);
  ...
  anim_pixels(
    [
      3908, 3909, 3910, 3911, 3912, 3913, 3914, 3892, 3893, 3894, 3895, 3896,
      3897, 3898, 3718, 3719, 3720, 3702, 3703, 3704, 3685, 3686, 3687, 3688,
      3689, 3669, 3670, 3671, 3672, 3673, 3652, 3653, 3654, 3655, 3656, 3657,
      3658, 3636, 3637, 3638, 3639, 3640, 3641, 3642, 3495, 3479, 3462, 3463,
      3464, 3446, 3447, 3448, 3429, 3430, 3431, 3432, 3433, 3413, 3414, 3415,
      3416, 3417, 3239, 3223,
    ],
    defualt_pix,
    { r: 0.439, g: 0.839, b: 1.0, x: 3, y: 3, z: 3 },
